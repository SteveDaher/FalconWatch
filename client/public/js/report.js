    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        document.getElementById('crime-report-form').addEventListener('submit', function(e) {
            ...
            const reportData = {
                category: formData.get('crime-category'),
                description: formData.get('crime-description'),
                coordinates: formData.get('crime-coordinates'),
                severity: "medium" // Set severity level or add a field in your form for it
            };
    
            // Check that all required fields are present
            if (!reportData.category || !reportData.description || !reportData.coordinates) {
                alert("Please fill in all required fields.");
                return;
            }
    
            // Emit the report data to the server
            socket.emit('reportCrime', reportData);
